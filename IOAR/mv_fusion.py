...
class MVFusionTransformer(torch.nn.Module):
    def __init__(self, input_depth, n_layers, n_attn_heads):
        super().__init__()
        self.transformer = transformer.Transformer(input_depth, input_depth * 2, \
            num_layers=n_layers, num_heads=n_attn_heads)
